...
DELETE FROM employee WHERE IsActive = 0

SELECT * FROM employee WHERE Gender = 'Female'

SELECT * FROM employee WHERE Gender = 'Male'

SELECT * FROM employee WHERE (CAST(GETDATE() AS DATE) - DOJ ) > 3

SELECT * FROM EMPLOYEE WHERE DATEDIFF(YEAR, DOB, GETDATE()) >= 50

SELECT DATEDIFF(YEAR, DOB, GETDATE()) AS AGE, * FROM EMPLOYEE WHERE DATEDIFF(YEAR, DOB, GETDATE()) >= 50

drop table employee1
SELECT *, DATEDIFF(YEAR, DOB, GETDATE()) AS AGE INTO employee1 FROM employee
...
select * from #employee1 WHERE AGE BETWEEN 85 AND 100

SELECT * FROM #employee1 WHERE Address LIKE '%Lane%'
SELECT * FROM #employee1 WHERE Address LIKE '%drive%'

SELECT * FROM #employee1 WHERE Address NOT LIKE '%park%'


SELECT DISTINCT AGE FROM #employee1

SELECT * FROM #employee1 WHERE DOJ IN ('2019-03-25', '2019-07-26')

SELECT * FROM #employee1 WHERE DOJ IN ('2019-03-25', '2019-07-26') order by age desc

SELECT * FROM #employee1 order by AGE

SELECT * FROM #employee1 order by DOB DESC
...
ALTER TABLE SALARY ADD JobLevel VARCHAR(10)
